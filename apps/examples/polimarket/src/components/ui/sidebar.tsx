...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "jstz-ui/ui/sheet";
import { Skeleton } from "jstz-ui/ui/skeleton";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "jstz-ui/ui/tooltip";
import { cn, cva } from "jstz-ui/utils";
...
function SidebarMenuSkeleton({
  ...
  const width = useMemo(() => {
    // TODO: Update this so it doesn't rely on impure `Math.random`.
